            ...
            <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                <form className='space-y-6'>
                    ...
                    <div>
                        ...
                        <div className='mt-1'>
                            <input type='text' name='text' autoComplete='text' required value={name} onChange={(e) => setName(e.target.value)}
                    ...
                    <div>
                        ...
                        <div className='mt-2 flex items-center'>
                            <span className='inline-block h-8 w-8 rounded-full overflow-hidden'>
                                {
                                    avater ? 
                                    (<img src={URL.createObjectURL(avater)} alt="avater" className='h-full w-full object-cover rounded-full' />)
                                    : (
